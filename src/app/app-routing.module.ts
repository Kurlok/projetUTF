...
{ path: '', redirectTo: 'pontagrossa', pathMatch: 'full' },
  ...
  { path: ':id/pesquisa', loadChildren: './pesquisa/pesquisa.module#PesquisaPageModule' },
  //{ path: 'agenda', loadChildren: './agenda/agenda.module#AgendaPageModule' },
  { path: ':id/agenda', loadChildren: './agenda/agenda.module#AgendaPageModule' },
  //{ path: 'sobre', loadChildren: './sobre/sobre.module#SobrePageModule' },
  { path: ':id/sobre', loadChildren: './sobre/sobre.module#SobrePageModule' },
  //{ path: 'cursos', loadChildren: './cursos/cursos.module#CursosPageModule' },
  { path: ':id/cursos', loadChildren: './cursos/cursos.module#CursosPageModule' },
